                    ...
                    <div class="row justify-content-center no-gutters">
                        <div class="col-md-10 d-flex align-items-center">
                            <div class="services-wrap rounded-right w-100">
                                <h3 class="heading-section text-center mb-4">Apa yang Anda tunggu?</h3>
                                ...
                                <p class="text-center mt-5">
                                    {{-- Tombol "Pesan Sekarang" untuk detail mobil --}}
                                    <a href="https://wa.me/6281234567890?text=Halo,%20saya%20tertarik%20untuk%20menyewa%20mobil%20{{$car->title}}%20dengan%20harga%20Rp{{$car->price}}/hari.%20Mohon%20informasi%20lebih%20lanjut."
                                        class="btn text-center mx-auto m-auto ml-auto btn-primary py-3 px-4" target="_blank">Pesan Sekarang</a>
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="car-wrap rounded ftco-animate">
                        ...
                        <div class="text">
                            ...
                            <div class="d-flex mb-3">
                                <p class="price ml-auto">Rp{{ $related_car->price }} <span>/hari</span></p>
                            </div>
                            <p class="d-flex mb-0 d-block">
                                {{-- Tombol "Pesan Sekarang" untuk mobil terkait --}}
                                <a href="https://wa.me/6281234567890?text=Halo,%20saya%20tertarik%20untuk%20menyewa%20mobil%20{{$related_car->title}}%20dengan%20harga%20Rp{{$related_car->price}}/hari.%20Mohon%20informasi%20lebih%20lanjut." class="btn btn-primary py-2 mr-1" target="_blank">Pesan Sekarang</a>
                                <a href="{{ route('car.show', $related_car->slug)}}" class="btn btn-secondary py-2 ml-1">Detail</a>
                            </p>
                        </div>
                    </div>
                </div>
